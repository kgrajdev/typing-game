...
export class GameOverScene extends Scene {
    ...
    create(data: { score: number, highScore: number }) {
        ...
        const sceneHeading1 = createImageText(this, "Game", width/2, height/6.5, checkWordFitmentOnScreen(this, 'game'), this.currentTheme,true, false)
        ...
        createImageText(this, String(data.score), width/2, height/2.0, checkWordFitmentOnScreen(this, String(data.score)), this.currentTheme,true, false)

        
        // highscore
        createImageText(this, `HighScore`, width/2, height/1.50, checkWordFitmentOnScreen(this, 'highscore'), this.currentTheme,true, false)
        createImageText(this, String(data.highScore), width/2, height/1.30, checkWordFitmentOnScreen(this, String(data.highScore)), this.currentTheme,true, false)
